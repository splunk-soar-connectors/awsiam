...
AWSIAM_PUT_USER_POLICY_ENDPOINT = "PutUserPolicy"
AWSIAM_JSON_PUT_USER_POLICY_RESPONSE = "PutUserPolicyResponse"
AWSIAM_JSON_POLICY_NAME = "PolicyName"
AWSIAM_JSON_POLICY_DOCUMENT = "PolicyDocument"
AWSIAM_REVOKE_SESSIONS_POLICY_NAME = "SOARDisableUserRevokeOlderSessions"
...
AWSIAM_USER_DISABLED_MSG = (
    "Console login and older temporary sessions for user {username} disabled successfully. "
    "Access keys were updated as requested; service-specific credentials, SSH keys, and signing certificates are unchanged."
)
...
AWSIAM_TIMEOUT = 30
AWSIAM_MAX_PAGINATION_PAGES = 1000
AWSIAM_MAX_RESPONSE_BYTES = 10 * 1024 * 1024
AWSIAM_MAX_PAGINATION_RESPONSE_BYTES = 10 * 1024 * 1024
AWSIAM_PAGINATION_TIMEOUT = 300
AWSIAM_MAX_ITEMS_PER_PAGE = 1000
AWSIAM_MAX_LIST_ITEMS = 100000
AWSIAM_PAGINATION_LIMIT_MSG = "Pagination stopped after reaching {limit}"
AWSIAM_RESPONSE_LIMIT_MSG = "AWS IAM response exceeded the {limit} byte limit"
AWSIAM_RESPONSE_TIMEOUT_MSG = "AWS IAM response exceeded the {timeout} second deadline"
AWSIAM_RESPONSE_DEADLINE_UNAVAILABLE_MSG = "Unable to enforce the AWS IAM response deadline"
AWSIAM_INVALID_PAGINATION_MARKER_MSG = "Pagination stopped because the server did not return a new marker"
